...
/* ============================================================
   1. ANGALIA
   ============================================================ */
Future<void> showWilayaViewDialog(
          ...
          children: [
            ...
            _Table(c: c, children: [
              _ViewRow(
                c: c,
                label: 'ID',
                value: Text(wilaya.id,
                    style: TextStyle(
                        color: c.text,
                        fontSize: 13,
                        fontFamily: 'monospace')),
              ),
              _ViewRow(c: c, label: 'JINA', value: _val(c, wilaya.name)),
              _ViewRow(
                c: c,
                label: 'MKOA',
                value: _Pill(
                  label: wilaya.regionName.isNotEmpty
                      ? wilaya.regionName
                      : wilaya.regionId,
                  fg: c.blue,
                  bg: c.blueBg,
              ...
              if (wilaya.vituoCount != null)
                _ViewRow(
                  c: c,
                  label: 'VITUO',
                  value: _val(c, _fmt(wilaya.vituoCount!), bold: true),
                ),
            ]),
            _Footer(
              c: c,
...
/* ============================================================
   2. HARIRI (au ONGEZA ukipitisha wilaya = null)
   ============================================================ */
Future<Wilaya?> showWilayaEditDialog(
  BuildContext context, {
  Wilaya? wilaya,
  required List<({String id, String name})> mikoa,
}) {
  return showDialog<Wilaya>(
    context: context,
    builder: (_) => _EditDialog(original: wilaya, mikoa: mikoa),
  );
}

class _EditDialog extends StatefulWidget {
  final Wilaya? original;
  final List<({String id, String name})> mikoa;
  const _EditDialog({this.original, required this.mikoa});
...
class _EditDialogState extends State<_EditDialog> {
  late final Wilaya o = widget.original ??
      const Wilaya(id: '', name: '', regionId: '');
...
/* ============================================================
   3. FUTA
   ============================================================ */
Future<bool> showWilayaDeleteDialog(
    BuildContext context, Wilaya wilaya) async {
